...
return new class extends Migration
{
    ...
    {
        Schema::table('parameter_templates', function (Blueprint $table) {
    ...
    public function down(): void
    {
        ...
        Schema::table('parameter_templates', function (Blueprint $table) {
            $table->integer('pulse_ratio')->default(1)->after('description');
            $table->decimal('score_to_money_rate', 10, 4)->default(1.0)->after('pulse_ratio');
            $table->integer('coin_to_score_rate')->default(10)->after('score_to_money_rate');
        });
