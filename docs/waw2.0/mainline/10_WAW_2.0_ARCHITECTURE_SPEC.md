...
- `brains/knowledge/03_system_architecture_designs/V9_SYSTEM_SPLITTING_DESIGN.md` - V9 系統拆分與資料庫解耦遷移設計書，了解新舊架構過渡細節。
...
- `brains/knowledge/02_protocols_and_standards/WEBSOCKET_CHANNEL_STANDARD.md` - WebSocket 頻道與事件唯一真理。
