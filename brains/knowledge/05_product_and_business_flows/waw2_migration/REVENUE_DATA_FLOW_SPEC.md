...
| `credit_in` | `02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` |
| `credit_out` | `02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` |
...
- `../../../02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - MQTT Payload 格式
- `../../../03_system_architecture_designs/WAW_2.0_ARCHITECTURE_SPEC.md` - WAW 2.0 架構規範
