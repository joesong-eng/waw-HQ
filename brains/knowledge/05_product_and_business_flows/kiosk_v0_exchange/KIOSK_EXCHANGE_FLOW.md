...
> **⚠️ 本章節僅供快速參考，完整規範請查閱：**  
> **`brains/knowledge/02_protocols_and_standards/QRCODE_FORMAT_STANDARD.md`**
...
依據 `brains/knowledge/02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md`：
...
- `brains/knowledge/05_product_and_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md` — 韌體層完整時序規範
- `brains/knowledge/02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` — MQTT 主題唯一真理
- `brains/knowledge/05_product_and_business_flows/kiosk_v0_exchange/KIOSK_ENGINEERING_DASHBOARD.md` — 工程測試頁設計
...
- `../../02_protocols_and_standards/QRCODE_FORMAT_STANDARD.md` - QR Code 格式規範，掃碼流程的唯一真理
- `../../02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - MQTT 主題規範，MQTT 通訊的唯一真理
- `../../02_protocols_and_standards/WEBSOCKET_CHANNEL_STANDARD.md` - WebSocket 頻道規範，即時通訊的唯一真理
- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_IDENTIFICATION_SYSTEM.md` - 識別碼體系，理解 chip_id/node_id/kiosk_id 的區別
- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md` - 紙鈔機互動流程，理解 escrow/stack/reject 時序

### 中關聯（建議讀）
> 了解完整業務流程，建議閱讀

- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_UX_AND_SCREEN_DESIGN.md` - 三螢幕 UX 流程，理解會員端、平板端、工程端的互動
- `../../04_ops_and_deployments/INFRASTRUCTURE_REFERENCE.md` - 基礎設施參考，理解 DB 架構和 API 端點
- `../../01_agent_governance_rules/AGENT_RESPONSIBILITY_BOUNDARIES.md` - Agent 職責邊界，了解 Member/Infra/Firmware 的分工

### 弱關聯（參考）
> 可選閱讀，提供額外背景

- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_ENGINEERING_DASHBOARD.md` - 工程測試頁設計，測試和調試工具
- `../../04_ops_and_deployments/DEPLOYMENT_GUIDE.md` - 部署指南，部署 Member/Infra 專案

### 排除混淆
> 容易混淆但實際無關的文件

- `../game_v0_arcade/05_product_and_business_flows/game_v0_arcade/GAME_V0_FLOW_AND_SESSION.md` - 遊戲機流程，不同的業務域（遊戲機開分 vs 兌幣機兌幣）
...
> ⚠️ **MQTT 主題規範請以 `brains/knowledge/02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` 為唯一真理。本文件第 8 節的主題列表必須與該文件保持一致。**
...
- `../../02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - MQTT 主題規範，本文件第 8 節必須與該文件保持一致
- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_IDENTIFICATION_SYSTEM.md` - 識別碼體系，理解 chip_id 在 MQTT 主題中的使用
- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md` - 會員兌幣流程，理解雲端如何處理 escrow/stack/reject

### 中關聯（建議讀）
> 了解完整系統架構，建議閱讀

- `../../04_ops_and_deployments/INFRASTRUCTURE_REFERENCE.md` - 基礎設施參考，理解 Infra MQTT Listener 的部署
- `../../01_agent_governance_rules/AGENT_RESPONSIBILITY_BOUNDARIES.md` - Agent 職責邊界，了解 Firmware (Fio) 的職責範圍

### 弱關聯（參考）
> 可選閱讀，提供額外背景

- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_UX_AND_SCREEN_DESIGN.md` - 三螢幕 UX 流程，理解整體用戶體驗
- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_ENGINEERING_DASHBOARD.md` - 工程測試頁設計，測試韌體功能

### 排除混淆
> 容易混淆但實際無關的文件

- `../game_v0_arcade/05_product_and_business_flows/game_v0_arcade/GAME_V0_FLOW_AND_SESSION.md` - 遊戲機流程，使用不同的韌體（IOTwawS3）和 MQTT 主題（`device/+/`）
- `../../02_protocols_and_standards/WEBSOCKET_CHANNEL_STANDARD.md` - WebSocket 頻道規範，韌體不使用 WebSocket（只用 MQTT）
...
### 強關聯（必讀）
- `brains/knowledge/02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - 技術命名與 Payload 數據負載標準規範，確保 API 與變數命名一致。
- `brains/knowledge/05_product_and_business_flows/kiosk_v0_exchange/KIOSK_IDENTIFICATION_SYSTEM.md` - 兌幣機識別碼與綁定體系。

### 中關聯（建議讀）
- `brains/knowledge/05_product_and_business_flows/kiosk_v0_exchange/KIOSK_UX_AND_SCREEN_DESIGN.md` - 兌幣機 UI 與三螢幕顯示設計。
