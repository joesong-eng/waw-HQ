...
> **日期**: 2026-05-12 (UTC+8)
> **韌體**: `IOTwawS3`（game_v0）
> **對應文件**: 兌幣卡識別碼見 `brains/knowledge/05_product_and_business_flows/kiosk_v0_exchange/KIOSK_IDENTIFICATION_SYSTEM.md`
...
| 識別碼文件 | `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_IDENTIFICATION_SYSTEM.md` | 本文件 |
