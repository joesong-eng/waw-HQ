...
> **維護者**: HQ（唯一寫入權）
> **狀態**: ✅ 設計定稿，待派任務實作
> **公開路徑**: `pubdocs/02_projects/hq/01_業務場景故事/05_product_and_business_flows/game_v0_arcade/GAME_V0_FLOW_AND_SESSION.md`
...
## 五、MQTT 規範（依 02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md）
...
### 強關聯（必讀）
- `brains/knowledge/05_product_and_business_flows/game_v0_arcade/GAME_V3_CORE_SPECIFICATION.md` - 遊戲機 3.0 系統架構與業務流程規格書。
