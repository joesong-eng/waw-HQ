...
> 
> **請以以下文件為準：**
> - UX 流程：`05_business_flows/kiosk_v0_exchange/KIOSK_UX_AND_SCREEN_DESIGN.md`（v3.0.0，2026-05-11）
> - 業務流程：`05_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md`（v2.2.0）
...
### 強關聯（必讀）
- `brains/knowledge/05_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md` - 兌幣機物理與金流交互流程。
