...
- `02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - MQTT topic 與 payload 命名標準。
- `02_protocols_and_standards/WEBSOCKET_CHANNEL_STANDARD.md` - WebSocket 頻道與事件規範。

### 中關聯

- `03_system_architecture_designs/SYSTEM_ENTRYPOINTS_AND_DOMAINS.md` - 系統入口與域名分工。
- `05_product_and_business_flows/device_connectivity/DEVICE_CONNECTION_STATUS_FLOW.md` - 設備連線狀態流程。
- `03_system_architecture_designs/V9_SYSTEM_SPLITTING_DESIGN.md` - 人與物拆分與即時事件聯動。
