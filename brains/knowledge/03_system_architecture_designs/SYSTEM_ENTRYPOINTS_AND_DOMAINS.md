...
- `04_ops_and_deployments/INFRASTRUCTURE_REFERENCE.md` - 主機、域名、Nginx 與部署位置參考。
- `03_system_architecture_designs/WAW_2.0_ARCHITECTURE_SPEC.md` - WAW 2.0 核心架構規格。
- `03_system_architecture_designs/V9_SYSTEM_SPLITTING_DESIGN.md` - 人與物分離、單一入口後端分流設計。

### 中關聯

- `01_agent_governance_rules/AGENT_RESPONSIBILITY_BOUNDARIES.md` - Agent 專案職責邊界。
- `02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - 域名、服務、Payload 與 Topic 命名標準。
- `04_ops_and_deployments/IHUB_APK_BUILD_TOOL.md` - iHub APK 與下載服務參考。
