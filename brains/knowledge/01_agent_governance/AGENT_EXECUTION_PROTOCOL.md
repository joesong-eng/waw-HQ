...
- [ ] MQTT 主題 → 先查 `02_technical_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md`
- [ ] API 端點 → 先查現有路由
- [ ] Port、服務、模組 → 先查現有配置
...
- `../02_technical_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - MQTT 主題規範，執行前三確認的範例
- `../02_technical_standards/WEBSOCKET_CHANNEL_STANDARD.md` - WebSocket 頻道規範，執行前三確認的範例
...
- `../05_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md` - 業務流程文件，與執行協議無直接關係（但執行時需遵守協議）
- `../04_deployment_operations/DEPLOYMENT_GUIDE.md` - 部署指南，與執行協議無直接關係（但部署時需遵守協議）
