...
- `brains/knowledge/03_system_architecture/V9_SYSTEM_SPLITTING_DESIGN.md` - V9 系統拆分遷移設計書，了解雙子專案與 Nginx 路由邊界。

### 中關聯（建議讀）
- `brains/knowledge/05_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md` - 兌幣機 MQTT 物理與金流交互流程。

### 排除混淆
- `brains/knowledge/05_business_flows/kiosk_v0_exchange/KIOSK_UX_AND_SCREEN_DESIGN.md` - 用戶端 UX UI，無涉底層 Payload 與 Naming 強制限制。
