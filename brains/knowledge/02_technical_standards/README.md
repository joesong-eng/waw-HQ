...
| 文件 | 核心內容 | 查閱時機 |
|------|---------|---------|
| `02_technical_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` 🔴 | MQTT 主題格式、Payload 規範、QoS/Retain 策略、ACL | 開發任何 MQTT 相關功能前 |
...
| `02_technical_standards/SIGNAL_FLOW_MONITOR.md` | 信號流可視化設計（待實作） | 除錯分散式通信流時參考 |
...
- `02_technical_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` 是唯一真理，發現不一致以此為準
