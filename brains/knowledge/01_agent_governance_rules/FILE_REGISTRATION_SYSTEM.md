...
創建文件：`brains/knowledge/01_agent_governance_rules/NEW_FILE.md`
...
git add brains/knowledge/01_agent_governance_rules/NEW_FILE.md
...
```bash
# 直接創建文件
touch brains/knowledge/01_agent_governance_rules/NEW_FILE.md
...
以下文件未在 DOCUMENT_INDEX.md 中註冊：
  ✗ 01_agent_governance_rules/NEW_FILE.md
...
- `01_agent_governance_rules/AGENT_EXECUTION_PROTOCOL.md` - Agent 執行協議，了解文件管理規範
- `01_agent_governance_rules/AGENT_COLLABORATION_PROTOCOL.md` - Agent 協作協議，了解知識沉澱規範
...
- `05_product_and_business_flows/` 下的業務流程文件 - 與文件註冊系統無直接關係
