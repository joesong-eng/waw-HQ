...
- `../../05_product_and_business_flows/game_v0_arcade/GAME_V0_FLOW_AND_SESSION.md` - 業務流程

### 中關聯（建議讀）
- `HARDWARE_PULSE_MAPPING.md` - 硬體脈衝映射
- `../../05_product_and_business_flows/waw2_migration/REVENUE_DATA_FLOW_SPEC.md` - 營收數據流
