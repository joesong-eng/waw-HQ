...
- `05_product_and_business_flows/kiosk_v0_exchange/KIOSK_IDENTIFICATION_SYSTEM.md`：識別碼體系（chip_id vs node_id）
...
- `../05_product_and_business_flows/kiosk_v0_exchange/KIOSK_IDENTIFICATION_SYSTEM.md` - node_id vs chip_id 詳解

### 中關聯（建議讀）
> 了解 WebSocket 在業務流程中的使用

- `../05_product_and_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md` - 兌幣流程中的 WebSocket 事件
- `02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - Infra 將 MQTT 轉為 WebSocket
- `QRCODE_FORMAT_STANDARD.md` - iHub 掃碼後監聽 WebSocket
- `../04_ops_and_deployments/INFRASTRUCTURE_REFERENCE.md` - Member Reverb 配置

### 弱關聯（參考）
> 提供額外背景

- `../05_product_and_business_flows/kiosk_v0_exchange/KIOSK_UX_AND_SCREEN_DESIGN.md` - 三端 UX 流程
- `../04_ops_and_deployments/DEPLOYMENT_GUIDE.md` - Member 部署步驟
