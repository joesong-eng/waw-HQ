...
- `../04_ops_and_deployments/INFRASTRUCTURE_REFERENCE.md` - 部署位置（iHub 在 yd47）

### 中關聯（建議讀）
> 了解 QR Code 在業務流程中的使用

- `../05_product_and_business_flows/kiosk_v0_exchange/KIOSK_EXCHANGE_FLOW.md` - 兌幣流程
- `WEBSOCKET_CHANNEL_STANDARD.md` - iHub 監聽 WebSocket
- `../04_ops_and_deployments/DEPLOYMENT_GUIDE.md` - 部署步驟

### 排除混淆
> 容易誤以為相關，但實際無關

- `02_protocols_and_standards/TECHNICAL_NAMING_AND_PAYLOAD_STANDARD.md` - 韌體不處理 QR Code
